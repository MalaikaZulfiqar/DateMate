      ...
      <View style={bookingStyle.box}>
        ...
        <View
          ...
          <View style={{ marginRight: 20 }}>
            ...
            <View style={[style.justifySpaBtwRow]}>
              <View>
              <Text style={[style.font12]}>Booking Code </Text>
              <Text style={bookingStyle.subTitle}>{code}</Text>
              </View>
              <View>
              {type === 'Awaiting' && (
                <TouchableOpacity style={[bookingStyle.appButton]}>
                  {icons.Awaiting}
                  <Text style={[bookingStyle.buttonText, bookingStyle.appText]}>Awaiting</Text>
                </TouchableOpacity>
              )}
              {type === 'Approved' && (
